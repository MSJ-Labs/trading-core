...
class OhlcvAggregatorTest {
    ...
    void firstTick_opensCandle_doesNotFlush() {
        ...
        OhlcvCandle candle = aggregator.currentCandle("BTCUSDT").orElseThrow();
    ...
    void newBucket_flushesCompletedCandle() {
        ...
        OhlcvCandle flushed = captor.getValue();
        ...
        OhlcvCandle newCandle = aggregator.currentCandle("BTCUSDT").orElseThrow();
    ...
    void differentSymbols_aggregatedIndependently() {
        ...
        assertThat(aggregator.currentCandle("BTCUSDT").orElseThrow().open()).isEqualByComparingTo("65000");
        assertThat(aggregator.currentCandle("ETHUSDT").orElseThrow().open()).isEqualByComparingTo("3000");
    }
